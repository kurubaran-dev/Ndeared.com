...
import dev.ndeared.com.ui.FriendsFragment;
import dev.ndeared.com.ui.GroupFragment;
import dev.ndeared.com.ui.LoginActivity;
import dev.ndeared.com.ui.UserProfileFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(toolbar != null) {
            ...
            getSupportActionBar().setTitle("Ndeared");
        }
...
//    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.about) {
            Toast.makeText(this, "Ndeared version 1.0", Toast.LENGTH_LONG).show();
            return true;
        }

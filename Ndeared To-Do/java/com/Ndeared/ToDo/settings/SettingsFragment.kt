...
import com.Ndeared.ToDo.BuildConfig
import com.Ndeared.ToDo.R
import com.Ndeared.ToDo.adapter.RecyclerViewAdapter
import com.Ndeared.ToDo.utils.BackupHelper
import com.Ndeared.ToDo.utils.DeviceInfo
import com.Ndeared.ToDo.utils.PreferenceHelper
...
class SettingsFragment : PreferenceFragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findPreference("about_version").onPreferenceClickListener = createPreferenceClickListener("https://github.com/Kurubaran-A/Ndeared-Inc")

        val rateThisApp = findPreference("rate_app")
        rateThisApp.onPreferenceClickListener = Preference.OnPreferenceClickListener {
            val appPackageName = activity.packageName
            try {
                startActivity(Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/developer?id=Ndeared+Inc&hl=en")))
        ...
        sendFeedback.onPreferenceClickListener = Preference.OnPreferenceClickListener {
            ...
            email.putExtra(Intent.EXTRA_EMAIL, arrayOf("support@ndeared.com"))
